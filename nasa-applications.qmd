...
GES DISC is working to provide users with VirtualiZarr services as part of its on-prem aggregation service deprecation efforts. The current plan is to enable VirtualiZarr support for the 10 most popular collections previously served through on-prem aggregation services.

...
**If you are a program lead,** it is suggested to start here with the main points about virtual stores. Then it is recommended to visit the [Executive Summary](./executive_summary.html) and [Recommendations](./recommendations.html). From there, you will likely want to also make note of the [Limitations](./limitations.html) and [Governance](./governance.html) sections.
**If you are looking to understand virtual stores at NASA on a more technical level,**, please visit the Technical Aspects sections. The [Resources](./resources.html) may also be of interest.

...
* For future missions, investigate the use of [discrete global grid systems](https://ecce.esri.ca/blog/2023/06/24/introduction-to-discrete-global-grid-system-dggs/) for future missions so lower level data products enable spatial and temporal alignment that will facilitate data processing and the generation of virtual data cubes.

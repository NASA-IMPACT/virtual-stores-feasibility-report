...
Non-cubable datasets are often labelled Level 2 (L2). They are often swath-based data, where observations are collected in strips rather than on a consistent grid. These datasets are often organized into "tiles" (e.g. Sentinel) or "frames" (e.g. OPERA and NISAR).
:::

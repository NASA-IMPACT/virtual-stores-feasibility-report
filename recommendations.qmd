...
For example, time series analysis is the primary use case for NISAR. A frame-oriented chunk manifest design ensures efficient per-frame loading. This decision should be made deliberately, with awareness of the trade-offs for other access patterns (see [Known Limitations](limitations.qmd)).

...
The path from Earthdata Login to open dataset should be simplified to broaden virtual stores adoption. This includes streamlining authentication processes and ensuring that users can easily discover and access virtual stores through familiar tools and interfaces.

## Documentation and onboarding 

Materials should be developed to support data providers in virtualizing their datasets and to help users understand how to access and work with virtual stores. This includes clear guides, best practices, and examples of code for generating and using virtual stores.
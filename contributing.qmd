...
3. **Open and merge a PR** with the `CITATION.cff` updates. The site will be published automatically on merge to `main`.
...
4. **Create a GitHub Release.** Go to [Releases → Draft a new release](https://github.com/NASA-IMPACT/virtual-stores-feasibility-report/releases/new):
   ...
   - Use Github to auto-generate release notes.
   - Publish the release.
